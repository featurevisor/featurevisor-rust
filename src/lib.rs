...
pub use evaluate::{Evaluation, EvaluationReason, EvaluationType, EvaluateOptions};
pub use events::{ContextSetDetails, DatafileSetDetails, EventDetails, EventHandler, EventName, StickySetDetails};
pub use instance::{create_featurevisor, Featurevisor, FeaturevisorOptions, OverrideOptions, SpawnOptions};
pub use modules::{
...
pub use types::{
    ...
    PlainCondition, Required, ResolvedVariableSchema, RuleKey, Segment, SegmentKey,
    StickyFeatures, Traffic, VariableOverride, VariableValue, Variation, VariationValue,
};
