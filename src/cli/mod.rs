...
pub use options::{AssessDistributionOptions, BenchmarkOptions, Cli, Command, CommonOptions, TestOptions};
...
pub fn run(cli: Cli) -> Result<(), String> {
    match cli.command {
        ...
        None => { println!("Learn more at https://featurevisor.com/docs/sdks/rust/"); Ok(()) }
    }
}
